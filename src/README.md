...
[docs]: https://doc.deno.land/https/deno.land/x/jamf_school@0.2.1/mod.ts
...
[Here's how to get your API credentials](https://doc.deno.land/https/deno.land/x/jamf_school@0.2.1/mod.ts#Credentials). You'll have to replace the token, ID, and URL in the examples.
...
```javascript
import * as jamf from "https://deno.land/x/jamf_school@0.2.1/mod.ts";
