...
Bad documentation is a bug! If something doesn't work as expected or you just want some help, please [raise an issue on GitHub](https://github.com/SeparateRecords/deno_jamf_school/issues).
